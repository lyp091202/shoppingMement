   ...
   public class JsHelper
    {
        ...
        {
            string js = "<script type='text/javascript'>alert('{0}');window.top.location.replace('{1}')</script>";
            HttpContext.Current.Response.Write(string.Format(js, message, toURL));
        }
        ...
        {
            string js = "<script type='text/javascript'>window.top.location.replace('{0}')</script>";
            HttpContext.Current.Response.Write(string.Format(js, ToUrl));
        }
