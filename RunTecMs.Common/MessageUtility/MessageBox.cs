...
namespace RunTecMs.Common.MessageUtility
{
   //页面中弹出对话框
   public class MessageBox
    {
        ...
        {
            page.ClientScript.RegisterStartupScript(page.GetType(), "message", "<script type='text/javascript' defer>alert('" + msg.ToString() + "');</script>");
        }
