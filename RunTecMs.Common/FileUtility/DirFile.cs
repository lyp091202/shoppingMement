   ...
   public class DirFile
    {
        ...
        /// 复制文件
        /// </summary>
        /// <param name="fileName1">要复制的文件的路径已经全名(包括后缀)</param>
        /// <param name="fileName2">目标位置,并指定新的文件名</param>
        /// <param name="localFlg">是否是本地文件</param>
        public static void CopyFileAllPath(string fileName1, string fileName2, bool localFlg = false)
        {
            ...
            if (localFlg == true)
            {
                int pathIndex = fileName2.LastIndexOf("\\");
                string floadPath = fileName2.Substring(0, pathIndex);

                if (IsExistDirectory(floadPath) == false)
                {
                    Directory.CreateDirectory(floadPath);
                }
            }
        ...
        /// 创建本地文件夹
        /// </summary>
        /// <param name="fileName">目标位置,并指定新的文件名</param>
        public static void CreatDirectory(string fileName)
        {
            ...
            string floadPath = fileName.Substring(0, pathIndex);
