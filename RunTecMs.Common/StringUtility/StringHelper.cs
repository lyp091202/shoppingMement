...
namespace RunTecMs.Common.StringUtility
{
    /// <summary>
    /// 字符串操作类
    ...
    public class StringHelper
    {
        ...
        /// 截断并用省略号处理
        /// </summary>
        /// <param name="src">没有被截断的</param>
        /// <param name="ToShowLen">要显示几个字符</param>
        /// <param name="LastWords">结尾符号，通常是省略号，所以设计成有默认值的参数</param>
        /// <returns></returns>
        public static string ForCutStr(string src, int ToShowLen, string LastWords = "...")
        {
            if (string.IsNullOrEmpty(src))
            {
                return "";
            }
            if (src.Length > ToShowLen)
            {
                return src.Substring(0, ToShowLen) + LastWords;
            }
            else
            {
                return src;
        ...
        /// 文字转为语音
        /// </summary>
        /// <param name="speechSounds">文字内容</param>
        /// <returns></returns>
        public static bool speak(string speechSounds)
        {
