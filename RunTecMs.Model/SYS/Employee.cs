...
namespace RunTecMs.Model.SYS
{
    ...
    public class Employee
    {
        ...
        //推广邀请码
        public string  ExtendInvitationCode { get; set; }
    ...
    public class EmployeeDepartmentRole
    {
        ...
        public string TrueName { get; set; }
        // 添加编辑用业务ID
        public int EmpBusinessValue { get; set; }
    }
    ...
    public class EmployeeInfo : Employee
    {
        ...
        // 亲组织ID
        public string ParOrganizationID { get; set; }
    }
    ...
    /// </summary>
    [Serializable]
    public class EmployeeDetailInfo : Employee
    {
        // 发发相关信息
        //公司ID
        public int CompanyID { get; set; }
    ...
    public class LoginEmployee : Employee
    {
        /// <summary>
        /// 当前员工最大角色Id
        /// </summary>
        ...
        /// 当前员工所属全部
        /// </summary>
        public int BusinessALL { get; set; }
        /// <summary>
        /// 当前员工所属发发
        /// </summary>
        public int BusinessFaFa { get; set; }
        /// <summary>
        /// 当前员工所属大决策
        /// </summary>
        public int BusinessDJC { get; set; }
        /// <summary>
        /// 当前员工所属沐融
        /// </summary>
        public int BusinessMR { get; set; }
        /// <summary>
        /// 部门名称
        /// </summary>
        public string DepName { get; set; }
